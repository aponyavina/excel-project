...
const {CleanWebpackPlugin} = require('clean-webpack-plugin');  // плагин для очищения папки dist
const HTMLWebpackPlugin = require('html-webpack-plugin');
const CopyPlugin = require('copy-webpack-plugin');
const MiniCssExtractPlugin = require('mini-css-extract-plugin');  // вынос CSS из JS в отдельный файл
...
module.exports = {
  ...
  resolve: {
    extensions: ['.js'],
    alias: {   // чтобы не писать длинные относительные пути, указываем папку через @, от которой будем двигаться
